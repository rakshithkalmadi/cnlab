...
-macTrace OFF \ 
-movementTrace ON 
#general operational descriptor storing the hop details in the network set god_ [create-god $val(nn)]
#create mobile nodes 
...
#define the destination procedure to set the destination to each node proc destination {} { 
global ns val n 
set now [$ns now] 
set time 5.0 
for {set i 0} {$i< $val(nn)} {incri} { 
